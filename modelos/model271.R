...
'
cat(modelo_prep.txt, file = 'modelo_prep.jags')

#--- Jags
# Familia de modelos
model.normal<-jags(data,inits_a, pars_a,model.file="modelo_prep.jags",n.iter=s,n.chains=2,n.burnin=s_cal)
...
saveRDS(model.normal,"model.normal")
