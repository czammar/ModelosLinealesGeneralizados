...
categorical_names <- c("genero_usuario", "bici", "ciclo_estacion_retiro","fecha_retiro",  "hora_retiro", "ciclo_estacion_arribo", "fecha_arribo", "hora_arribo", "hora_retiro_int", "tipo_estacion_retiro", "districtcode_retiro", "nearbystation0", "nearbystation1") 
...
ui<-fluidPage(
  ...
  ( # Seleccion de inputs para el analisis: variables y tipo de grafico a desplegar
    selectInput("dataset","Datos:", choices =list(ECOBICIS = "df"), selected=NULL), # Datos en que se basa el analisis
...
server<-(function(input, output, session){
  ...
  observe({
    ...
    updateSelectInput(session, "variable3", choices = c("genero_usuario", "bici", "ciclo_estacion_retiro","fecha_retiro",  "hora_retiro", "ciclo_estacion_arribo", "fecha_arribo", "hora_arribo", "hora_retiro_int", "tipo_estacion_retiro", "districtcode_retiro", "nearbystation0", "nearbystation1") 
    )
  })
