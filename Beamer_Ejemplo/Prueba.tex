...
%
\title[Proyecto]{Nombre de projecto}
\author{Ely, Laura, Miguel, César}
\institute[ITAM]
...
\begin{frame}
\section{Imágenes}
\frametitle{Soy una imagen}
A simple example...
	\begin{figure}
		\includegraphics[scale=0.15]{images/gato.jpeg}
